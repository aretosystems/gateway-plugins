 ...
 *
 * @version 1.0.0
 * @author  Areto Systems
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */

class AretoClass
{
    public $api_id = MODULE_PAYMENT_ARETO_API_KEY;
    public $api_session = MODULE_PAYMENT_ARETO_SESSION_KEY;
    ...
    { //echo '<pre>'; print_r($_SERVER['SERVER_ADDR']); echo '</pre>'; exit();
        // Default options
        $default = array(
            'order_id' => '',
            'amount' => 0,
