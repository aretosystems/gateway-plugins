...
if (!class_exists('Areto', false)) {
    require_once(Mage::getBaseDir('lib') . '/areto-sdk/Areto.php');
}

class Areto_Payments_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function makeInvoice(&$order, $online = false)
    {
        ...
        $invoice->addComment(Mage::helper('areto')->__('Auto-generated from Areto'), false, false);
