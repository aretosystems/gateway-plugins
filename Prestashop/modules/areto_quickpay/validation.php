...
if (!isset($_POST['InternalOrderID']) ||
    ...
    $module->displayError('Unable to process payment');
    //die(Tools::displayError('Unable to process payment'));
}

if ($_POST['Result'] != '1') {
    $module->displayError('Payment failed');
    //die(Tools::displayError('Payment failed'));
}
