 ...
 */
class Qp extends AbstractMethod implements GatewayInterface
{
    const METHOD_CODE = 'areto_qp';
     ...
     * @var string
     */
    //protected $_formBlockType = 'Areto\Payments\Block\Form\Qp';
    protected $_infoBlockType = 'Areto\Payments\Block\Info\Qp';
